...
-- Created: 2025-11-30T12:32:43.218Z
...
CREATE TABLE appointments (
      ...
      amount DECIMAL(10,2),
      date DATETIME,
      status TEXT DEFAULT 'scheduled', payment_method TEXT DEFAULT "cash", expenses DECIMAL(10,2) DEFAULT 0, cash_payment DECIMAL(10,2) DEFAULT 0, discount_type TEXT DEFAULT "amount", discount_value DECIMAL(10,2) DEFAULT 0, price_before_discount DECIMAL(10,2) DEFAULT 0, payment_reference TEXT, notes TEXT, staff INTEGER, down_payment DECIMAL(10,2) DEFAULT 0, bank_transfer DECIMAL(10,2) DEFAULT 0, payment_status TEXT DEFAULT "partial", created_at DATETIME,
      FOREIGN KEY (patient_id) REFERENCES patients (id)
    );
INSERT INTO appointments (id, patient_id, treatment, amount, date, status, payment_method, expenses, cash_payment, discount_type, discount_value, price_before_discount, payment_reference, notes, staff, down_payment, bank_transfer, payment_status, created_at) VALUES
  ('17', NULL, 'Manicure', '400', '2025-10-02', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('19', NULL, 'General Consultation', '400', '2025-10-02', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('39', '7', 'Promo Treatment: Sample Promo Treatment', '1599', '2025-10-25', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('40', '7', 'General Consultation', '499', '2025-10-25', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('41', '7', 'Promo Treatment: Sample Promo Treatment', '1599', '2025-10-25', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('42', '7', 'General Consultation', '499', '2025-10-28', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('43', '7', 'General Consultation', '499', '2025-10-28', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('44', '7', 'General Consultation', '499', '2025-10-28', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('49', '7', 'Glutathione', '750', '2025-11-28', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('50', '10', 'Glutathione', '750', '2025-11-19', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('51', '10', 'Glutathione', '750', '2025-11-19', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('52', '10', 'Glutathione', '750', '2025-11-21', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('53', '10', 'Glutathion', '750', '2025-11-23', 'scheduled', 'cash', '0', '750', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'full', NULL),
  ('54', '10', 'Glutathion', '750', '2025-11-23', 'scheduled', 'cash', '0', '750', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'full', NULL),
  ('55', '10', 'Glutathion', '750', '2025-11-23', 'scheduled', 'cash', '0', '0', 'amount', '0', '0', NULL, NULL, NULL, '0', '0', 'partial', NULL),
  ('56', '10', 'Acne Removal', '999', '2025-11-27', 'scheduled', 'cash', '0', '999', 'amount', '0', '999', '', '', '202', '0', '0', 'full', NULL),
  ('57', '10', 'Acne Removal', '999', '2025-11-27', 'scheduled', 'cash', '0', '999', 'amount', '0', '999', '', '', '202', '0', '0', 'full', NULL);
